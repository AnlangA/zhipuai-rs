...
impl fmt::Display for ChatModelName {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            ChatModelName::GLM4Z1Air => write!(f, "glm-z1-air"),
            ChatModelName::GLM4Z1AirX => write!(f, "glm-z1-airx"),
            ChatModelName::GLM4Z1AirFlash => write!(f, "glm-z1-air-flash"),
...
impl From<ChatModelName> for &'static str {
    fn from(model: ChatModelName) -> Self {
        match model {
            ...
            ChatModelName::GLM4Z1Air => "glm-z1-air",
            ChatModelName::GLM4Z1AirX => "glm-z1-airx",
            ChatModelName::GLM4Z1AirFlash => "glm-z1-air-flash",
